...
np.savetxt('export_from_python.csv',my_data,delimiter=',')
...
plt.figure(1)
plt.plot(time/60.0,sensors[:,0],'ro')
plt.plot(time/60.0,avg,'b.')
# add text labels to the plot
plt.legend(['Sensor 1','Average Sensors 1-4'])
plt.xlabel('Time (min)')
plt.ylabel('Sensor Values')
# save the figure as a PNG file
plt.savefig('my_Python_plot1.png')
# show the figure on the screen (pauses execution until closed)
plt.show()
plt.figure(1)
plt.plot(time/60.0,sensors[:,2],'ro')
plt.plot(time/60.0,avg,'b.')
# add text labels to the plot
plt.legend(['Sensor 3','Average Sensors 1-4'])
plt.xlabel('Time (min)')
plt.ylabel('Sensor Values')
# save the figure as a PNG file
plt.savefig('my_Python_plot3.png')
# show the figure on the screen (pauses execution until closed)
plt.show()

plt.figure(1)
plt.plot(time/60.0,sensors[:,3],'ro')
plt.plot(time/60.0,avg,'b.')
# add text labels to the plot
plt.legend(['Sensor 4','Average Sensors 1-4'])
plt.xlabel('Time (min)')
plt.ylabel('Sensor Values')
# save the figure as a PNG file
plt.savefig('my_Python_plot4.png')
# show the figure on the screen (pauses execution until closed)
plt.show()